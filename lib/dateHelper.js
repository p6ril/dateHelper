...
/**
* @class dateHelper
* @param {String} [locale="en"] - an optional locale parameter as a string (i.e. "en", "fr", ... defaults to English)
*/
...
function dateHelper (locale) {
    ...
    */
    ...
    this.isValidDate = function (date) {
        var _date = !this.empty(date) && typeof date === 'object' ? _.clone(date) : null;
